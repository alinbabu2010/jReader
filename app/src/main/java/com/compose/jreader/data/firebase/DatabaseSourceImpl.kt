...
class DatabaseSourceImpl @Inject constructor(
     ...
     */
    override fun saveBookToFirebase(bookData: BookUi?) = callbackFlow {
     ...
     */
    override suspend fun getAllBooksFromFirebase(): ResponseWrapper<List<BookUi?>> {
        val dbCollection = fireStore.collection(Constants.BOOK_DB_NAME)
        return try {
     ...
     */
    override fun updateBookById(bookId: String, updateData: Map<String, Comparable<*>?>) =
        callbackFlow {
            val dbCollection = fireStore.collection(Constants.BOOK_DB_NAME)
     ...
     * @return CallBackFlow sending a boolean value
     */
    override fun deleteBookById(bookId: String) = callbackFlow {
        val dbCollection = fireStore.collection(Constants.BOOK_DB_NAME)
